    ...
    <div class="sm:flex sm:items-center">
      <div class="px-2 pt-2 pb-5 border-gray-800 sm:flex sm:py-0 sm:px-0">
        ...
        <div class="flex pt-4 sm:pt-0 md:pt-0 lg:pt-0 xl:pt-0">
          ...
          <a
            href="https://github.com/ivanmolto/sillabus"
            target="_blank"
            rel="noopener"
          ...
          <a
            href="https://arweave.net/27WsYOcNHWweInDArUK94_GsBeuQKPXalsnwVPPRfe4?to=wv_3q4_df0jXCVUJjCMYuYLSUcjIbrk9ggp_Ovix8yI"
            target="_blank"
            rel="noopener"
